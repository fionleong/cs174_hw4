...
function Chart(chart_id, data)
{
    ...
    var property_defaults = {
        ...
        'position' : 'absolute',
        'list-style' : 'none',
        'bar_width' : '40', // width of bar in histogram
        ...
        'type' : 'LineGraph', // currently, can be either a LineGraph or
            //PointGraph
	'type' : 'Histogram', // can now also be a histogram
    ...
    /**
     * Draws a histogram i.e., bar graph consisting of corresponding x-y plots
     * of points in data, each adjacent x-y pair connected by a bar
     */
